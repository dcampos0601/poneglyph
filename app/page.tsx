...
const fitScoreOptions: Array<"All" | FitScoreLevel> = [
  "All",
  "High",
  "Medium",
  "Low",
...
export default function SalesConsolePage() {
  ...
  const [routeTypeFilter, setRouteTypeFilter] = useState<
    (typeof routeTypeOptions)[number]
  >("All");
  const [fitScoreFilter, setFitScoreFilter] = useState<
    (typeof fitScoreOptions)[number]
  >("All");
  const [workStatusFilter, setWorkStatusFilter] = useState<
    (typeof workStatusOptions)[number]
  >("All");
  ...
  const activeFilters = useMemo<LeadFilters>(
    () => ({
      routeType:
        routeTypeFilter === "All"
          ? undefined
          : (routeTypeFilter as RouteType),
      fitScore:
        fitScoreFilter === "All"
          ? undefined
          : (fitScoreFilter as FitScoreLevel),
      workStatus:
        workStatusFilter === "All"
          ? undefined
          : (workStatusFilter as WorkStatus),
  ...
  const detailLead = useMemo(
    () =>
      selectedLead
        ? leads.find((lead) => lead.leadId === selectedLead.leadId) ||
          selectedLead
        : null,
    [leads, selectedLead],
  );
  ...
  const handleMarkWorked = async (leadId: string) => {
    ...
    try {
      ...
      if (!updated) return;
      setLeads((prev) =>
        prev.map((lead) => (lead.leadId === leadId ? updated : lead)),
      );
      setSelectedLead((prev) =>
        prev && prev.leadId === leadId ? updated : prev,
      );
    } finally {
          ...
          <div className="grid gap-4 lg:grid-cols-5">
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                onChange={(event) =>
                  setRouteTypeFilter(event.target.value as (typeof routeTypeOptions)[number])
                }
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                onChange={(event) =>
                  setFitScoreFilter(event.target.value as (typeof fitScoreOptions)[number])
                }
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                onChange={(event) =>
                  setWorkStatusFilter(event.target.value as (typeof workStatusOptions)[number])
                }
              >
        ...
        {detailLead ? (
          <div className="flex h-full flex-col">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium text-slate-900">
                    {detailLead.routeType}
                  </p>
                </div>
                <div>
                  <SectionLabel label="Owner" />
                  <p className="font-medium text-slate-900">
                    {detailLead.leadOwner}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">
                    {detailLead.workStatus}
                  </p>
                </div>
                <div>
                  <SectionLabel label="Last Touch" />
                  <p className="font-medium text-slate-900">
                    {formatDate(detailLead.lastTouchDate)}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-xl border border-slate-200 p-3">
                  ...
                  <ul className="mt-3 space-y-1 text-xs text-slate-600">
                    ...
                    <li>
                      Flags:{" "}
                      {detailLead.residentialExposure ? "Residential" : "-"},{" "}
            ...
            <div className="mt-auto flex flex-col gap-3 border-t border-slate-200 pt-4">
              ...
              >
                {workingLeadId === detailLead.leadId
                  ? "Updating..."
